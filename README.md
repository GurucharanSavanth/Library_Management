...
- User Login Credentials: (Guru/Guru)
...
- : Tomcat v8.0+ [https://youtu.be/mLFPodZO8Iw?t=903] ## Profered 8.0 To Run Directly
- : MySQL Server [https://www.youtube.com/watch?v=Ydh5jYA6Frs] ## Select Full Install not Developer Install
...
insert into users values('Guru','Guru','Gurucharan','S','Bangalore','1236547089','scamtest2003@gmail.com',2);
...
Step 1: Click On File > Import > Git > Projects From Git > Clone Uri > Paste The Repository Url as: ```git clone https://github.com/GurucharanSavanth/Library_Management.git ```> Select master Branch > Next > Next > Finish.
...
<bold>Thanks a lot,</bold><br/>
                                                                                                        Project By<br/>
                                                                                                         <b>Gurucharan.S</b># Library_Management
# Library_Management
